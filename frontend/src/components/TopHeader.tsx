          ...
          <div className="flex items-center gap-3 self-end sm:self-auto w-full sm:w-auto justify-end">
            ...
            <div className="relative flex-1 sm:w-60 max-w-xs">
              ...
              <input
                ...
                className="w-full pl-9 pr-12 py-2 bg-slate-100/90 border border-transparent focus:border-indigo-300 focus:bg-white rounded-xl text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition-all"
              />
              <div className="absolute right-2 top-1/2 -translate-y-1/2 pointer-events-none">
                <kbd className="hidden sm:inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[9px] font-bold text-slate-400 bg-slate-200/60 rounded border border-slate-300/60">
